...
The dataset is provided in this case, if you need to use other datasets you can refer to the detailed steps in **[Getting Started](../../starter/getting_started)**.
...
The following steps are implemented in `torch_fedavg_mnist_lr_step_by_step_example.py`
