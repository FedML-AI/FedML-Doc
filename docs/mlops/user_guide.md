...
After you finish the local developing/debugging of the FedML project using FedML library (e.g., successfully run the example [example](/en/cross-silo/examples/mqtt_s3_fedavg_mnist_lr_example.md)), 
...
![image](/image/mlops_create_application.png) 
...
After [installing the FedML library](../starter/installation.md) at your edge devices, you can bind it to MLOps platform with a simple CLI:
``` sh
...
![image](/image/MLOps_edge_devices.png)
...
![image](/image/MLOps_invite_collaborators.png)
...
![image](/image/MLOps_group_management.png)
...
![image](/image/mlops_start_run.png)
...
![image](/image/MLOps_experimental_tracking_status.png)

- visualizing training results
![image](/image/MLOps_experimental_tracking_curve.png)

- visualizing system performance
![image](/image/MLOps_experimental_tracking_system.png)

- model downloading/serving
![image](/image/model_download.jpg)
...
- distributed logging
![image](/image/MLOps_experimental_tracking_logging.png)
...
[//]: # ()
[//]: # (![MLOps Configuration]&#40;/image/backend_mlops.jpeg&#41;)
